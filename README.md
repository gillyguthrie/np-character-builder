...
Loadouts save to small `.json` files you can share and load back in.

Built by and for the NP community. Item data comes from the server-items wiki archive and in-game tooltip captures. Report errors or missing items on the server Discord.
